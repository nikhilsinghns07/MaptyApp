...
More Features to add:
    ...
    2.ability to delte a workout.
    3.abillity to delete all workout.
    4.ability to sort workout by a certian field.
    5.Re-build Running an Cycling objects coming from Local Storage.
    6 .More realistic error and confirmation messages.
    7.Ability to posioton the map to show all workouts.
    8.Ability to draw lines and shapes insead of just points.
    9.Geocode location from coordinates.
    10.Display weathere data or workout time and place.
*/
